...
namespace
{
    ...
    TEST(AlignmentBlockStaticTest, Comparison)
    {
        ...
        a->addSequence(kReferenceSequenceId, seq1);
        b->addSequence(kReferenceSequenceId, seq2);
